...
namespace imgmaker
{
	...
	DEFINE_LAYER_TYPE(layerSoftmax, "layerSoftmax");
	std::string layerSoftmax::getLayerType() const
	{
		return layerType;
	}
	void layerSoftmax::forward(const std::shared_ptr<DataBucket> prev, std::shared_ptr<DataBucket> next)
	{
	...
	void layerSoftmax::backward(std::shared_ptr<DataBucket> prev, const std::shared_ptr<DataBucket> next,
