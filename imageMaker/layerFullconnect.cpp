...
namespace imgmaker
{
	...
	DEFINE_LAYER_TYPE(layerFullconnect, "layerFullconnect");
	std::string layerFullconnect::getLayerType() const
	{
		return layerType;
	}
	void layerFullconnect::setParamaters(const ParamSize _outMapSize, const bool _enabledBias)
	{
	...
	std::string layerFullconnect::serializeToString() const
	{
	...
	void layerFullconnect::serializeFromString(const std::string content)
	{
	...
	void layerFullconnect::solveInnerParams()
	{
	...
	void layerFullconnect::forward(const std::shared_ptr<DataBucket> prev, std::shared_ptr<DataBucket> next)
	{
	...
	void layerFullconnect::backward(std::shared_ptr<DataBucket> prev, const std::shared_ptr<DataBucket> next,
