...
namespace imgmaker
{
	...
	//¾í»ýºË Î¬Êý
	void layerConvolution::setParamaters(const ParamSize _kernelSize, const size_t _widthStep, const size_t _heightStep, const bool _enabledBias, const PaddingType _padddingType)
	{
	...
	std::string layerConvolution::serializeToString() const
	{
	...
	void layerConvolution::serializeFromString(const std::string content)
	{
	...
	DEFINE_LAYER_TYPE(layerConvolution, "layerConvolution");
	std::string layerConvolution::getLayerType() const
	{
		return layerType;
	}

	void layerConvolution::solveInnerParams()
	{
	...
	void layerConvolution::forward(const std::shared_ptr<DataBucket> prev, std::shared_ptr<DataBucket> next)
	{
	...
	void layerConvolution::backward(std::shared_ptr<DataBucket> prev, const std::shared_ptr<DataBucket> next,
