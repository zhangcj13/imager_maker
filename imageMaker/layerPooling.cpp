...
namespace imgmaker
{
	...
	void layerPooling::setParamaters(const PoolingType _poolingType, const ParamSize _poolingKernelSize, const size_t _widthStep, const size_t _heightStep, const PaddingType _paddingType)
	{
	...
	std::string layerPooling::serializeToString() const
	{
	...
	void layerPooling::serializeFromString(const std::string content)
	{
	...
	DEFINE_LAYER_TYPE(layerPooling, "layerPooling");
	std::string layerPooling::getLayerType() const
	{
		return layerType;
	}

	void layerPooling::solveInnerParams()
	{
	...
	void layerPooling::forward(const std::shared_ptr<DataBucket> prev, std::shared_ptr<DataBucket> next)
	{
	...
	void layerPooling::backward(std::shared_ptr<DataBucket> prev, const std::shared_ptr<DataBucket> next,
